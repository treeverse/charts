...
# 1.12.31
:new: What's new:
- Update lakeFS Enterprise version to [1.102.0](https://docs.lakefs.io/releases/lakefs-enterprise/1.102.0/)

# 1.12.30
:new: What's new:
- Update lakeFS Enterprise version to [1.101.1](https://docs.lakefs.io/releases/lakefs-enterprise/1.101.1/)

# 1.12.29
:new: What's new:
- Update lakeFS Enterprise version to [1.101.0](https://docs.lakefs.io/releases/lakefs-enterprise/1.101.0/)

# 1.12.28
:new: What's new:
- Update lakeFS Enterprise version to [1.100.0](https://docs.lakefs.io/releases/lakefs-enterprise/1.100.0/)

# 1.12.27
:new: What's new:
- Update lakeFS Enterprise version to [1.99.0](https://docs.lakefs.io/releases/lakefs-enterprise/1.99.0/)

# 1.12.26
:new: What's new:
- Update lakeFS Enterprise version to [1.98.0](https://docs.lakefs.io/releases/lakefs-enterprise/1.98.0/)

# 1.12.25
:new: What's new:
- Update lakeFS Enterprise version to [1.97.0](https://docs.lakefs.io/releases/lakefs-enterprise/1.97.0/)

# 1.12.24
:new: What's new:
- Update lakeFS Enterprise version to [1.96.0](https://docs.lakefs.io/releases/lakefs-enterprise/1.96.0/)
...
# 1.12.21
:new: What's new:
- Update lakeFS community version to [1.86.0](https://github.com/treeverse/lakeFS/releases/tag/v1.86.0)
...
# 1.12.18
:new: What's new:
- Update lakeFS Enterprise version to [1.93.0](https://docs.lakefs.io/releases/lakefs-enterprise/1.93.0/)

# 1.12.17
:new: What's new:
- Update lakeFS community version to [1.84.1](https://github.com/treeverse/lakeFS/releases/tag/v1.84.1)
